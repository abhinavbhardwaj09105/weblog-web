            ...
            <div className="flex gap-6 justify-between">
                ...
                <div className="flex gap-6 items-center">

                    {
                        ...
                        <Link to={`/editor/${blog_id}`} className="underline hover:text-logoGreen">Edit</Link> : ""
                    }

                    <Link to={`https://twitter.com/intent/tweet?text=Read ${title}&url=${location.href}`}> <img src={ theme == 'light' ? x : xDark } alt="" className="w-5 h-5"/> </Link>
                </div>
            </div>
