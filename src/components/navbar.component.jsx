...
import darkLogo from "../imgs/logoo-dark.svg";
    ...
    return (
        <>
            <nav className="navbar z-50">
                ...
                <Link to="/" className="flex-none md:w-40 w-32">
                    <img src={ theme == "light" ? logo : darkLogo } className="w-full" />
                </Link>

                <div className={"absolute bg-white w-full left-0 top-full mt-0.5 py-4 px-[5vw] md:border-0 md:block md:relative md:inset-0 md:p-0 md:w-auto md:show " + ( searchBoxVisibility ? "show" : "hide" )}>
                    <input 
                        type="text"
                        placeholder="Search"
                ...
                <div className="flex items-center gap-3 md:gap-6 ml-auto">
                    ...
                    <button className="w-10 h-10 rounded-full bg-grey relative hover:bg-black/10" onClick={changeTheme}>
